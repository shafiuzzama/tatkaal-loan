...
//       $.get('/sub-admin/get-chart-record',{year},  // url
//               function (data) { 
...
//   var options={series:[
//                         {name:'Sales',data:[500,450,600,700,500,450,600,700,750,780,850,990],},
//                         {name:'Purchase',data:[-210,-540,-450,-350,-210,-540,-450,-350,-200,-100,-700,-960]}],
//                         colors:['#28C76F','#EA5455'],
//                         chart:{type:'bar',height:300,stacked:true,zoom:{enabled:true}},
//                         responsive:[{breakpoint:280,options:{legend:{position:'bottom',offsetY:0}}}],
//                         plotOptions:{bar:{horizontal:false,columnWidth:'20%',endingShape:'rounded'},},
//                         xaxis:{categories:[' Jan','feb','march','april','may','june','july','auguest','september','october','november','december'],},
//                         legend:{position:'right',offsetY:40},fill:{opacity:1}};
